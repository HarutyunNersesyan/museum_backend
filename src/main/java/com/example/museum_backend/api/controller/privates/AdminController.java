...
public class AdminController {
    ...
    public ResponseEntity<?> createEventWithImages(
        ...
        try {
            ...
            requestDTO.setEventCategory(com.example.museum_backend.model.enums.EventCategory.valueOf(eventCategory));
            requestDTO.setEventType(com.example.museum_backend.model.enums.EventType.valueOf(eventType));
            requestDTO.setEventDate(java.time.LocalDateTime.parse(eventDate));
            ...
            requestDTO.setLocation(com.example.museum_backend.model.enums.Location.valueOf(location));
            ...
            logger.info("Event with images created successfully by admin: {}", getCurrentUserEmail());
            return ResponseEntity.status(HttpStatus.CREATED).body(event);
        } catch (Exception e) {
